...
description: "Clarify ambiguous requirements through focused dialogue..."
---
<!-- hermes-add-skill: description trimmed from 286 chars to fit Hermes' 60-char index -->
<!-- original description: Clarify ambiguous requirements through focused dialogue before implementation. Use when requirements are unclear, features are complex (>2 days), or involve cross-team coordination. Ask two core questions - Why? (YAGNI check) and Simpler? (KISS check) - to ensure clarity before coding. -->
