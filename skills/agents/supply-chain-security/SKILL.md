...
description: "Audit software supply chain: deps, artifacts, SLSA."
---
...
Converted from `~/.claude/agents/supply-chain-security.md` by `hermes-add-agent`. Edit that file and re-run to sync; this copy
