...
description: "Conducting comprehensive security audits"
---

<!-- Claude tools declared upstream: `Read, Grep, Glob`. Hermes equivalents: read → read_file / search_files; edit → patch; write → write_file; bash → terminal; grep / glob → search_files; webfetch / websearch → web_extract / web_search; task → delegate_task. -->
...
Converted from `/var/folders/l2/n127hxrn5h55fxg78cff6s8w0000gn/T/hermes-add-agent-k5kgjg_s.md` by `hermes-add-agent`. Edit that file and re-run to sync; this copy
