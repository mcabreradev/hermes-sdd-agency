...
description: "Simplifies and refines code for clarity, consistency"
---
...
Converted from `~/.claude/agents/code-simplifier.md` by `hermes-add-agent`. Edit that file and re-run to sync; this copy
