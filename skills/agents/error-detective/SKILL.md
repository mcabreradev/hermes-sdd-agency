...
description: "Diagnose why errors are occurring in your system"
---
...
Converted from `~/.claude/agents/error-detective.md` by `hermes-add-agent`. Edit that file and re-run to sync; this copy
