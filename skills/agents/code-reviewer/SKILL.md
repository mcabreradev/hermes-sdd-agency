---
name: code-reviewer
description: "Conduct comprehensive code reviews focusing on code quality"
---
...
Converted from `~/.claude/agents/code-reviewer.md` by `hermes-add-agent`. Edit that file and re-run to sync; this copy
