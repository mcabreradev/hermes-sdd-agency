...
description: "Deep-dive analysis of unfamiliar codebases; mental model"
---
...
Converted from `~/.claude/agents/codebase-explorer.md` by `hermes-add-agent`. Edit that file and re-run to sync; this copy
