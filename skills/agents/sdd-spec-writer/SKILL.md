...
description: "Spec-driven development specs: executable contracts."
---
...
Converted from `~/.claude/agents/sdd-spec-writer.md` by `hermes-add-agent`. Edit that file and re-run to sync; this copy
