...
description: "Design, establish, or optimize Git workflows"
---
...
Converted from `~/.claude/agents/git-workflow-manager.md` by `hermes-add-agent`. Edit that file and re-run to sync; this copy
