---
name: typescript-pro
description: "Implementing TypeScript code requiring advanced type..."
---
...
Converted from `~/.claude/agents/typescript-pro.md` by `hermes-add-agent`. Edit that file and re-run to sync; this copy
