...
description: "Comprehensive patterns for creating, maintaining"
risk: unknown
source: community
date_added: "2026-02-27"
---
<!-- hermes-add-skill: description trimmed from 178 chars to fit Hermes' 60-char index -->
<!-- original description: Comprehensive patterns for creating, maintaining, and managing Architecture Decision Records (ADRs) that capture the context and rationale behind significant technical decisions. -->
